  ...
  return (
    <div className="bg-white">
      <section className="mx-auto max-w-xl px-6 py-20 text-center">
        <p className="text-xs font-bold uppercase tracking-widest text-[#2d459c]">
        ...
        <div className="mt-8 flex flex-col gap-3">
          <a
            href={portal}
            className="inline-flex items-center justify-center rounded-xl bg-[#2d459c] px-4 py-3 text-sm font-semibold text-white hover:bg-[#1e3278]"
          >
